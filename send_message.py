...
def send_message():
    ...
    if friend_choice!=-1:
        ...
        patternsave='^SOS|SAVE ME|IN DANGER|HELP|sos|save me|in danger|help$'
        ...
        if(len(text)>100):
            ...
            try:
                ...
                friends[friend_choice].chat.append(chatobject)      #putting the chat according to selected friend object list
                #Successful message
                ...
                if (re.match(patternsave, text.upper()) != None):
                    print colored("Keep Calm!!!!I'll be there soon!",'green')
            except IOError:
